...
public class PatchTurtleRenderer extends ClassMerger {
    ...
    public PatchTurtleRenderer() {
        super(
            "dan200.computercraft.client.render.TileEntityTurtleRenderer",
            "org.squiddev.cctweaks.core.patch.TurtleRenderer_Patch");
    }
    ...
    public ClassVisitor patch(String className, ClassVisitor delegate) throws Exception {
        ...
        }.onMethod("func_147500_a")
            .onMethod("renderTileEntityAt")
            .once()
            .mustFind();
    }
}
