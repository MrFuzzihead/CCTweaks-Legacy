...
public abstract class TurtleRenderer_Patch extends TileEntityTurtleRenderer {
    ...
    @MergeVisitor.Stub
    private void renderTurtle(ITurtleTile a, ComputerFamily b, Colour c, ITurtleUpgrade d, ITurtleUpgrade e, float f,
        float g, ResourceLocation overlay, ResourceLocation hatOverlay) {}
}
