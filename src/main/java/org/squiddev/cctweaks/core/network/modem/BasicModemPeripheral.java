...
public class BasicModemPeripheral<T extends BasicModem> extends ModemPeripheral
    implements IPeripheralTargeted, IBinaryHandler, IPeripheralWithArguments {
    ...
    public Object[] callMethod(IComputerAccess computer, ILuaContext context, int method, Object[] arguments)
        ...
        switch (method - methodLength) {
            case 0: { // getNamesRemote
                ...
                for (String name : modem.getAttachedNetwork()
                    .getPeripheralsOnNetwork()
                    .keySet()) {
                    table.put(idx++, name);
                }
    ...
    @Override
    public Object[] callMethod(IComputerAccess computer, ILuaContext context, int method, IArguments arguments)
        throws LuaException, InterruptedException {
    ...
    public void attach(IComputerAccess computer) {
        ...
        if (controller != null) {
            for (Map.Entry<String, IPeripheral> peripheral : controller.getPeripheralsOnNetwork()
                .entrySet()) {
