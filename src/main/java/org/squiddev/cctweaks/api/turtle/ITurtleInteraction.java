...
public interface ITurtleInteraction {
     ...
     */
    TurtleCommandResult swing(ITurtleAccess turtle, IComputerAccess computer, FakePlayer player, ItemStack stack,
     ...
     */
    boolean canSwing(ITurtleAccess turtle, FakePlayer player, ItemStack stack, ForgeDirection direction,
     ...
     * @throws LuaException If an error occurs
     */
    TurtleCommandResult use(ITurtleAccess turtle, IComputerAccess computer, FakePlayer player, ItemStack stack,
        ForgeDirection direction, MovingObjectPosition hit) throws LuaException;
     ...
     */
    boolean canUse(ITurtleAccess turtle, FakePlayer player, ItemStack stack, ForgeDirection direction,
        MovingObjectPosition hit);
}
