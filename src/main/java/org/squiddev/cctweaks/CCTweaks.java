...
public class CCTweaks {
    ...
    public static final String DEPENDENCIES = "required-after:ComputerCraft@[2.0.0,);after:CCTurtle;after:ForgeMultipart;after:OpenPeripheralCore;after:OpenPeripheral";
