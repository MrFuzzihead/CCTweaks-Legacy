        ...
        if (!player.capabilities.isCreativeMode) {
            ...
            if (remaining > 0) {
                player.addChatMessage(
                    new ChatComponentText("7 gold required. Need " + remaining + " more.")
    ...
    public void init() {
        ...
        // Add some impostor recipes for NEI. We just use CC's default ones
        {
            ...
            GameRegistry.addRecipe(
                new ImpostorShapelessRecipe(
                    ComputerItemFactory.create(-1, null, ComputerFamily.Advanced),
                    new Object[] { ComputerItemFactory.create(-1, null, ComputerFamily.Normal), stack }));
            ...
            GameRegistry.addRecipe(
                new ImpostorShapelessRecipe(
                    ...
                    new Object[] { PocketComputerItemFactory.create(-1, null, ComputerFamily.Normal, false), stack }));

            // Wireless pocket computer
            GameRegistry.addRecipe(
                new ImpostorShapelessRecipe(
                    PocketComputerItemFactory.create(-1, null, ComputerFamily.Advanced, true),
                    new Object[] { PocketComputerItemFactory.create(-1, null, ComputerFamily.Normal, true), stack }));
        }
    }
}
