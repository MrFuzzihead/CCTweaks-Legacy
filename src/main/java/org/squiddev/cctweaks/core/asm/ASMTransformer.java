...
public class ASMTransformer implements IClassTransformer {
    ...
    public ASMTransformer() {
        ...
        add(
            new Object[] {
                ...
                new DisableTurtleCommand(), new PatchTurtleRenderer(), new TurtleBrainAlsoPeripheral(),
                ...
                new ClassMerger(
                    ...
                    public boolean matches(String className) {
                        return super.matches(className) && Loader.isModLoaded(MultipartIntegration.NAME)
                            && Config.Integration.cbMultipart;
                    }
                },
                new ClassMerger(
                ...
                new PatchOpenPeripheralAdapter(), new PatchOpenModule(),
    ...
    private void checkCC() {
        loadedCC = true;
        for (ModContainer x : Loader.instance()
            .getModList()) {
            if (x.getName()
