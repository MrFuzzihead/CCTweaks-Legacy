...
public class PeripheralHelpersTest {
    ...
    public static final IPeripheralHelpers helpers = CCTweaksAPI.instance()
        .peripheralHelpers();
    ...
    public void testGetTarget() throws Exception {
        ...
        assertTarget("Prefer Target", target, new TargetProxy(target, new Proxy(new Targeted(target))));

        assertTarget("Return proxy on null target", target, new TargetProxy(null, new Proxy(new Targeted(target))));
