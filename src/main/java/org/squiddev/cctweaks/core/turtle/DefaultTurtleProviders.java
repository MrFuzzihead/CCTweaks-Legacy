...
public class DefaultTurtleProviders extends Module {
    ...
    public void init() {
        ...
        NetworkAPI.registry()
            .addNodeProvider(new INetworkNodeProvider() {
                ...
                public IWorldNetworkNode getNode(ITurtleAccess turtle, TurtleSide side) {
                    ...
                    if (upgrade != null) {
                        ...
                        if (upgrade instanceof IWorldNetworkNodeHost)
                            return ((IWorldNetworkNodeHost) upgrade).getNode();
                    }
        ...
        CCTweaksAPI.instance()
            .turtleRegistry()
            .registerInteraction(new AbstractTurtleInteraction() {

                @Override
                public boolean canUse(ITurtleAccess turtle, FakePlayer player, ItemStack stack,
                    ForgeDirection direction, MovingObjectPosition hit) {
