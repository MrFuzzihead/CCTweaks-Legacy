...
public class DisableTurtleCommand implements IPatcher {
    ...
    public ClassVisitor patch(final String className, final ClassVisitor delegate) throws Exception {
        return new ClassVisitor(ASM5, delegate) {
            ...
            public MethodVisitor visitMethod(int access, String name, String desc, String signature,
                ...
                if (name.equals("execute") && desc.equals(
                    "(Ldan200/computercraft/api/turtle/ITurtleAccess;)Ldan200/computercraft/api/turtle/TurtleCommandResult;")) {
    ...
    protected static class DisabledCommandVisitor extends MethodVisitor {
        ...
        public void visitCode() {
            ...
            visitLdcInsn(
                className.substring(PREFIX.length(), className.length() - SUFFIX.length())
                    .toLowerCase());
            ...
            visitMethodInsn(
                ...
                "failure",
                "(Ljava/lang/String;)Ldan200/computercraft/api/turtle/TurtleCommandResult;",
                false);
            visitInsn(ARETURN);
