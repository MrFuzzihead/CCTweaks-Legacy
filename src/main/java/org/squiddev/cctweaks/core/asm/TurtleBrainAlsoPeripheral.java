...
public class TurtleBrainAlsoPeripheral implements IPatcher {
    ...
    public boolean matches(String className) {
        return className.equals("dan200.computercraft.shared.turtle.core.TurtleBrain")
            || className.equals("dan200.computercraft.shared.turtle.blocks.TileTurtle");
    }
        ...
        if (className.equals("dan200.computercraft.shared.turtle.core.TurtleBrain")) {
            return new FindingVisitor(
                ...
                new MethodInsnNode(
                    ...
                    "getType",
                    "()Ldan200/computercraft/api/turtle/TurtleUpgradeType;",
                    true),
                new FieldInsnNode(
                    GETSTATIC,
            ...
            }.onMethod("hasPeripheralUpgradeOnSide")
                .once()
                .mustFind();
        }
    }
