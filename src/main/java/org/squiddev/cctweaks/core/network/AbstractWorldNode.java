...
public abstract class AbstractWorldNode extends AbstractNode implements IWorldNetworkNode {
    ...
    public Set<INetworkNode> getConnectedNodes() {
        return NetworkAPI.helpers()
            .getAdjacentNodes(this);
    }

    /**
     * Attempt to connect to {@link #getConnectedNodes()} using
     * {@link NetworkHelpers#joinOrCreateNetwork(INetworkNode, Set)}
     */
    public void connect() {
        NetworkAPI.helpers()
            .joinOrCreateNetwork(this, getConnectedNodes());
    }
