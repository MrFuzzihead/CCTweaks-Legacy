...
public class MultipartHelpers {
    ...
    private static final Cuboid6[] peripheralOcclusion = new Cuboid6[] {
        new Cuboid6(0.125, 0.0, 0.125, 0.875, 0.125, 0.875D), new Cuboid6(0.125, 0.875, 0.125, 0.875, 1.0, 0.875D),
        new Cuboid6(0.125, 0.125, 0.0, 0.875, 0.875, 0.125D), new Cuboid6(0.125, 0.125, 0.875, 0.875, 0.875, 1.0D),
        new Cuboid6(0.0, 0.125, 0.125, 0.125, 0.875, 0.875D), new Cuboid6(0.875, 0.125, 0.125, 1.0, 0.875, 0.875D), };
    ...
    private static final Cuboid6[] peripheralBounds = new Cuboid6[] {
        new Cuboid6(0.125, 0.0, 0.125, 0.875, 0.1875, 0.875), new Cuboid6(0.125, 0.8125, 0.125, 0.875, 1.0, 0.875),
        new Cuboid6(0.125, 0.125, 0.0, 0.875, 0.875, 0.1875), new Cuboid6(0.125, 0.125, 0.8125, 0.875, 0.875, 1.0),
        new Cuboid6(0.0, 0.125, 0.125, 0.1875, 0.875, 0.875), new Cuboid6(0.8125, 0.125, 0.125, 1.0, 0.875, 0.875), };
